...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SmolMind Pretraining")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"SmolMind-Pretrain-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
        wandb.init(
            project=args.wandb_project, 
            name=wandb_run_name, id=wandb_id, 
            resume=resume,
